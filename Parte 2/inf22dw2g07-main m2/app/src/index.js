...
const App2 = () => {
  ...
  const handleLogin = () => {
    axios.get(`http://${window.location.hostname}:3009/auth/github`) 
    .then(response => {
    ...
    <React.StrictMode>
      {loggedIn ? (
        <>
          ...
          <div className='rights'>&copy;App-Musicas-2023&nbsp;</div>
        </>
      ) : (
        <>
        <h1 className='loginPage'>App-Musicas-2023</h1>
