...
CREATE TABLE `musica` (
  ...
  KEY `idalbum` (`idalbum`),
  CONSTRAINT `musica_ibfk_1` FOREIGN KEY (`idartista`) REFERENCES `artista` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `musica_ibfk_2` FOREIGN KEY (`idalbum`) REFERENCES `idalbum` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `album` (
  ...
  PRIMARY KEY (`id`),
  KEY `idartista` (`idartista`),
  CONSTRAINT `album_ibfk_1` FOREIGN KEY (`idartista`) REFERENCES `artista` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
